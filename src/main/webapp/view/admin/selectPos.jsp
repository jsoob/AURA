                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <c:forEach var="vo" items="${list}">
										<tr>
											<td class="text-center"><a href="admin?cmd=modifyPos&posNo=${vo.posNo}">${vo.posNo}</a></td>
											<td class="text-center"><a href="admin?cmd=modifyPos&posNo=${vo.posNo}">${vo.posName}</a></td>
