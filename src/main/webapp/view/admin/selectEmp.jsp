		...
		$.ajax({
            ...
            success: (data) => {
				...
				$.each(rows, (idx, row) => {
					...
					appendText +="<td><a href='admin?cmd=modifyEmp&empNo="+ row.empNo +"'>"+ row.deptName +"</a></td>";
					appendText +="<td><a href='admin?cmd=modifyEmp&empNo="+ row.empNo +"'>"+ row.empNo +"</a></td>";
					appendText +="<td><a href='admin?cmd=modifyEmp&empNo="+ row.empNo +"'>"+ row.empName +"</a></td>";
					appendText +="<td><a href='admin?cmd=modifyEmp&empNo="+ row.empNo +"'>"+ row.posName +"</a></td>";
					appendText +="<td><a href='admin?cmd=modifyEmp&empNo="+ row.empNo +"'>"+ row.empEmail +"</a></td>";
					appendText +="<td><a href='admin?cmd=modifyEmp&empNo="+ row.empNo +"'>"+ row.hiredate +"</a></td>";
					appendText +="<td><a href='admin?cmd=modifyEmp&empNo="+ row.empNo +"'>"+ 
            	...
            	/* 
            	<tr name="empList">
					<td class=""><a href="admin?cmd=modifyEmp&empNo=${vo.empNo}">${vo.deptName}</a></td>
					<td class=""><a href="admin?cmd=modifyEmp&empNo=${vo.empNo}">${vo.empNo}</a></td>
					<td class=""><a href="admin?cmd=modifyEmp&empNo=${vo.empNo}">${vo.empName}</a></td>
					<td class=""><a href="admin?cmd=modifyEmp&empNo=${vo.empNo}">${vo.posName}</a></td>
					<td class=""><a href="admin?cmd=modifyEmp&empNo=${vo.empNo}">${vo.empEmail}</a></td>
					<td class=""><a href="admin?cmd=modifyEmp&empNo=${vo.empNo}">${vo.hiredate}</a></td>
				</tr>
				 */
            },
                                ...
                                <table id="selectTable">
                                    ...
                                    <c:forEach var="vo" items="${empList}">
										<tr name="empList">
											...
											<td class=""><a href="admin?cmd=modifyEmp&empNo=${vo.empNo}">${vo.empEmail}</a></td>
											<td class=""><a href="admin?cmd=modifyEmp&empNo=${vo.empNo}">${vo.hiredate}</a></td>
											<td class=""><a href="admin?cmd=modifyEmp&empNo=${vo.empNo}">${( vo.quitdate == null || row.quitdate == "" ? "근무중" : vo.quitdate )}</a></td>
										</tr>
									</c:forEach>
                                </table>
                            </div>
